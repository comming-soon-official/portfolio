...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: 'GitHub',
        url: 'https://github.com/comming-soon-official',
        icon: Icons.github,
      },
      LinkedIn: {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/himal-b-180b701a5/',
        icon: Icons.linkedin,
      },
      Twitter: {
        name: 'X',
        url: 'https://x.com/commingsoon9626',
        icon: Icons.x,
      },
      Email: {
        name: 'Send Email',
              ...
              <TooltipTrigger asChild>
                ...
                >
                  {resolvedTheme === 'light' ? (
                    ...
                    <Sun className="h-[1.2rem] w-[1.2rem] " onClick={() => setTheme('light')} />
                  )}
